...
<div class="container">
        ...
        <h1 class="my-3"><a href="{{route('user.profile')}}" class="text-capitalize">profile</a></h1>
        <div class="ms-3">
            <h2 class="my-3 fs-4 text-capitalize">create address</h2>
            ...
            <form action="{{route('user.profile.address.store')}}" method="POST" style="max-width: 600px;">
                ...
                <div class="d-grid">
                    <input type="submit" value="add address" class="btn btn-dark text-capitalize">
                </div>
            </form>
