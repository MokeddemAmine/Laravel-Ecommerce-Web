...
@section('content')
  ...
  <section class="shop_section layout_padding">
    ...
    <button id="btn-filtering" style="width:150px;position:absolute;top:7rem;transition:.5s;z-index:1000;" class="text-uppercase btn btn-outline-dark fw-bold">filter & sort <i class="fa-solid fa-sliders"></i></button>
    <form action="{{route('search.products')}}" method="GET" id="filtering" class="p-3 bg-white border border-light" style="width:500px;max-width:100%;position:absolute;top:7rem;left:-200%;transition:.5s;z-index:1000;">
      <h1 class="text-capitalize text-dark border-bottom pb-3 fs-3 d-flex justify-content-between align-items-center"><span>filter & sort</span> <span style="cursor: pointer;" id="hide-filtering" ><i class="fa-solid fa-left-long"></i></span></h1>
      ...
      <div class="d-grid gap-2 my-2">
        <a href="{{route('shop')}}" class="text-uppercase btn btn-outline-warning fw-bold">reset</a>
      </div>
